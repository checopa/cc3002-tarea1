...
public class PsychicTest {
    ...
    public void setUp(){
        ...
        psychic2Pokemon=new BasicPsychicPokemon("Psychic2",005,100,new ArrayList<>(Arrays.asList(firstAttack,secondAttack)));
        fightingPokemon=new BasicFightingPokemon("Fire",001,100,new ArrayList<>(Arrays.asList(firstAttack,secondAttack)));
        firstTrainer=new Trainer("Ash",new ArrayList<>(Arrays.asList(psychic2Pokemon,grassPokemon)));
        secondTrainer=new Trainer("Ashn't",new ArrayList<>(Arrays.asList(psychicPokemon,fightingPokemon,waterPokemon)));
